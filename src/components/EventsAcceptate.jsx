  ...
  return (
    ...
    <section style={{ overflowY: 'scroll', height: '100vh' }}>
      ...
      <div className="flex  w-full  font-bold justify-center items-center">
        ...
        <div className="table-cell text-center py-8  bg-slate-600 w-1/3 mx-4 rounded-md text-slate-100 drop-shadow-2xl text-xl">Evenimete Acceptate</div>
...
export default EventsAcceptate;
